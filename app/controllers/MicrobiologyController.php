...
class MicrobiologyController extends \BaseController {
	...
	public function store()
	{
		...
		if ($validator->fails()) {
			...
			$patient->district_residence = empty(Input::get('district_residence')) ? Null : Input::get('district_residence');
			$patient->district_workplace = empty(Input::get('district_workplace')) ? Null : Input::get('district_workplace');
